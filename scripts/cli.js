...
const contractABI = require("../artifacts/contracts/Subwooferomen.sol/Subwooferomen.json").abi;

program
    .name("subwooferomen-cli")
    .description("CLI tool for Subwooferomen smart contract")
    .version("1.0.0");
